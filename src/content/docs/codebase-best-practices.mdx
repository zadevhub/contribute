...
The colors are defined in [`variable.css`](/client/src/components/layouts/variables.css), and the fonts are in [`fonts.css`](https://github.com/freeCodeCamp/freeCodeCamp/blob/main/client/src/components/layouts/fonts.css).
